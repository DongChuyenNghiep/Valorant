...
fetch(FULL_URL_TABLE_A)
  ...
  .then((rep) => {
    ...
    let dataBody = document.getElementById('table_ranktable');
    for (let i = 0; i < data.table.rows.length; i++) {
      ...
      firstcol.appendChild(rank);
      firstcol.appendChild(ign);
      cell0.appendChild(firstcol);
